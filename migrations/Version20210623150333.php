 ...
 */
final class Version20210623150333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_in_store (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(5) NOT NULL, amount INTEGER NOT NULL)');
